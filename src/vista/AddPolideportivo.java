...
public class AddPolideportivo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Añadir Polideportivo");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Polideportivo p=new Polideportivo(c.getCod(),c.getLocalizacion(),c.getJefe(),
                c.getCod_sede(),c.getCod(),infoJTextArea.getText());
        polideportivoDao.insert(p);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPolideportivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPolideportivo().setVisible(true);
            }
        });
    }
